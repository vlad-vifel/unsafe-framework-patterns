  ...
  <div class="space-y-8">
    ...
    <div class="space-y-2">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
        <RouterLink v-for="cat in allCategories" :key="cat.id" :to="`/category/${cat.id}`"
    ...
    <Card class="gap-3 py-5 bg-card/60 shadow-none">
      <CardContent class="space-y-2">
        ...
        <p class="text-sm text-muted-foreground leading-relaxed">
          ...
          JavaScript frameworks. Each pattern entry includes a description of the vulnerability, a realistic
          insecure example, and a secure alternative with best-practice guidance.
        </p>
      </CardContent>
    </Card>
  </div>
...
import { Layers, Tag, ArrowRight } from 'lucide-vue-next'
...
const frameworkCount = allFrameworks.length
